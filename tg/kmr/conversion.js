...
car = car.replace(/(B|C|Ç|D|F|G|H|J|K|L|M|N|P|Q|R|S|Ş|T|V|Y|X|Ẍ|Y|Z)Е/g, "$1ЙЕ");
car = car.replace(/(B|C|Ç|D|F|G|H|J|K|L|M|N|P|Q|R|S|Ş|T|V|Y|X|Ẍ|Y|Z|b|c|ç|d|f|g|h|j|k|l|m|n|p|q|r|s|ş|t|v|y|x|ẍ|y|z)е/g, "$1йе");
car = car.replace(/(B|C|Ç|D|F|G|H|J|K|L|M|N|P|Q|R|S|Ş|T|V|Y|X|Ẍ|Y|Z)E/g, "$1Е");
car = car.replace(/(B|C|Ç|D|F|G|H|J|K|L|M|N|P|Q|R|S|Ş|T|V|Y|X|Ẍ|Y|Z|b|c|ç|d|f|g|h|j|k|l|m|n|p|q|r|s|ş|t|v|y|x|ẍ|y|z)e/g, "$1е");
