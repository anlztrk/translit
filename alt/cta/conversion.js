...
function cyrlat() {
	...
	car = car.replace(/(А|Е|Ё|И|О|Ӧ|У|Ӱ|Ы|Ю|Я)Щ(А|Е|Ё|И|О|Ӧ|У|Ӱ|Ы|Ю|Я)/g, "$1ШШ$2");
	car = car.replace(/(А|Е|Ё|И|О|Ӧ|У|Ӱ|Ы|Ю|Я)щ(а|е|ё|и|о|ӧ|у|ӱ|ы|ю|я)/g, "$1Шш$2");
	car = car.replace(/(а|е|ё|и|о|ӧ|у|ӱ|ы|ю|я)щ(а|е|ё|и|о|ӧ|у|ӱ|ы|ю|я)/g, "$1шш$2");
	...
	car = car.replace(/(Б|В|Г|Д|Ј|Ж|З|К|Л|М|Н|Ҥ|П|Р|С|Т|Ф|Х|Ч|Ш|Щ|б|в|г|д|ј|ж|з|к|л|м|н|ҥ|п|р|с|т|ф|х|ч|ш)ю/g, "$1ӱ");
	car = car.replace(/(Б|В|Г|Д|Ј|Ж|З|Й|К|Л|М|Н|Ҥ|П|Р|С|Т|Ф|Х|Ч|Ш|Щ|б|в|г|д|ј|ж|з|й|к|л|м|н|ҥ|п|р|с|т|ф|х|ч|ш)Е/g, "$1Э");
	car = car.replace(/(Б|В|Г|Д|Ј|Ж|З|Й|К|Л|М|Н|Ҥ|П|Р|С|Т|Ф|Х|Ч|Ш|Щ|б|в|г|д|ј|ж|з|й|к|л|м|н|ҥ|п|р|с|т|ф|х|ч|ш)е/g, "$1э");
	car = car.replace(/(Б|В|Г|Д|Ј|Ж|З|К|Л|М|Н|Ҥ|П|Р|С|Т|Ф|Х|Ч|Ш|Щ|б|в|г|д|ј|ж|з|к|л|м|н|ҥ|п|р|с|т|ф|х|ч|ш)Ё/g, "$1Ӧ");
	car = car.replace(/(Б|В|Г|Д|Ј|Ж|З|К|Л|М|Н|Ҥ|П|Р|С|Т|Ф|Х|Ч|Ш|Щ|б|в|г|д|ј|ж|з|к|л|м|н|ҥ|п|р|с|т|ф|х|ч|ш)ё/g, "$1ӧ");
