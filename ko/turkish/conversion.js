...
function cyrlat () {
  ...
  car = car.replace(/시/g, 'Şᅵ');
  car = car.replace(/씨/g, 'Şᅵ');
  car = car.replace(/샤/g, 'Şᅡ');
  car = car.replace(/쌰/g, 'Şᅡ');
  car = car.replace(/섀/g, 'Şᅢ');
  car = car.replace(/썌/g, 'Şᅢ');
  car = car.replace(/셔/g, 'Şᅥ');
  car = car.replace(/쎠/g, 'Şᅥ');
  car = car.replace(/셰/g, 'Şᅦ');
  car = car.replace(/쎼/g, 'Şᅦ');
  car = car.replace(/쇼/g, 'Şᅩ');
  car = car.replace(/쑈/g, 'Şᅩ');
  car = car.replace(/슈/g, 'Şᅮ');
  car = car.replace(/쓔/g, 'Şᅮ');
  car = car.replace(/쉬/g, 'Şᅱ');
  car = car.replace(/쒸/g, 'Şᅱ');
