...
car = document.transcription.text1.value;
  ...
  car = car.replace(/yᅡ/g, "ㅑ");
  car = car.replace(/yᅢ/g, "ᅢ");
  car = car.replace(/yᅥ/g, "ㅕ");
  car = car.replace(/yᅦ/g, "ㅖ");
  car = car.replace(/yᅩ/g, "ㅛ");
  car = car.replace(/yᅮ/g, "ㅠ");
  car = car.replace(/ᅳy/g, "ㅢ");
  car = car.replace(/wᅡ/g, "ㅘ");
  car = car.replace(/wᅢ/g, "ㅙ");
  car = car.replace(/Wᅦ/g, "ㅚ");
  car = car.replace(/Wᅵ/g, "ㅚ");
  car = car.replace(/wᅥ/g, "ㅝ");
  car = car.replace(/wᅦ/g, "ㅞ");
  car = car.replace(/wᅵ/g, "ㅟ");
  ...
  car = car.replace(/(Q|R|Y|U|I|Ğ|Ü|A|F|H|L|İ|Z|X|V|N|M|Ö|ğ|ü|f|z|x|v|ö)/g, "");
