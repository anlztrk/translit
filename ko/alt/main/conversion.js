...
function cyrlat () {
  ...
  car = car.replace(/셔/g, 'shyŏ');
  car = car.replace(/쎠/g, 'ṡhyŏ');
  ...
  car = car.replace(/ᅥ/g, 'ơ ');
  car = car.replace(/ᅦ/g, 'é');
  car = car.replace(/ᅧ/g, 'yơ');
