...
function cyrlat () {
  ...
  car = car.replace(/셔/g, 'shyë');
  car = car.replace(/쎠/g, 'ṡhyë');
  ...
  car = car.replace(/ᅥ/g, 'ë');
  car = car.replace(/ᅦ/g, 'é');
  car = car.replace(/ᅧ/g, 'yë');
