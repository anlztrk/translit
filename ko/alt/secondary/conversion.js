...
function cyrlat () {
  ...
  car = car.replace(/셔/g, 'shyĕ');
  car = car.replace(/쎠/g, 'ṡhyĕ');
  ...
  car = car.replace(/ᅥ/g, 'ĕ');
  car = car.replace(/ᅦ/g, 'é');
  car = car.replace(/ᅧ/g, 'yĕ');
