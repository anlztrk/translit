...
car = document.transcription.text1.value;
  ...
  car = car.replace(/(Б|В|Г|Ғ|Д|Ж|З|Й|К|Қ|Л|М|Н|Ң|П|Р|С|Т|Ф|Х|Ш|Ь|Ъ|б|в|г|ғ|д|ж|з|й|к|қ|л|м|н|ң|п|р|с|т|ф|х|ш|ь|ъ)У(а|о|ұ|ы|ә|е|ө|ү|і|и)/g, "$1Ӱӯ$2");
  car = car.replace(/(Б|В|Г|Ғ|Д|Ж|З|Й|К|Қ|Л|М|Н|Ң|П|Р|С|Т|Ф|Х|Ш|Ь|Ъ|б|в|г|ғ|д|ж|з|й|к|қ|л|м|н|ң|п|р|с|т|ф|х|ш|ь|ъ)у(А|О|Ұ|Ы|Ә|Е|Ө|Ү|І|И|а|о|ұ|ы|ә|е|ө|ү|і|и)/g, "$1ӱӯ$2");
