...
function cyrlat() {
	...
	car = car.replace(/(б|в|г|д|ж|з|й|к|л|м|н|п|р|с|ҫ|т|ф|х|ц|ч|ш)Я/g, "$1ьА");
	car = car.replace(/(Б|В|Г|Д|Ж|З|Й|К|Л|М|Н|П|Р|С|Ҫ|Т|Ф|Х|Ц|Ч|Ш|б|в|г|д|ж|з|й|к|л|м|н|п|р|с|ҫ|т|ф|х|ц|ч|ш)я/g, "$1ьу");
	car = car.replace(/(Б|В|Г|Д|Ж|З|Й|К|Л|М|Н|П|Р|С|Ҫ|Т|Ф|Х|Ц|Ч|Ш)Ю/g, "$1ЬУ");
	car = car.replace(/(б|в|г|д|ж|з|й|к|л|м|н|п|р|с|ҫ|т|ф|х|ц|ч|ш)Ю/g, "$1ьУ");
	car = car.replace(/(Б|В|Г|Д|Ж|З|Й|К|Л|М|Н|П|Р|С|Ҫ|Т|Ф|Х|Ц|Ч|Ш|б|в|г|д|ж|з|й|к|л|м|н|п|р|с|ҫ|т|ф|х|ц|ч|ш)ю/g, "$1ьа");
