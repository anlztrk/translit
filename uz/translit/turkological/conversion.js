function cyrlat() {
	...
	document.transcription.text2.value = document.transcription.text1.value
		...
		.replace(/(G|K|Y)A/g, "$1Ä")
		.replace(/(G|K|Y)I/g, "$1İ")
		.replace(/(G|K|Y)O/g, "$1Ö")
		.replace(/(G|K|Y)U/g, "$1Ü")
		.replace(/(G|K|Y|g|k|y)a/g, "$1ä")
		.replace(/(G|K|Y|g|k|y)ı/g, "$1i")
		.replace(/(G|K|Y|g|k|y)o/g, "$1ö")
		.replace(/(G|K|Y|g|k|y)u/g, "$1ü")
