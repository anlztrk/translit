function cyrlat() {
	...
	document.transcription.text2.value = document.transcription.text1.value
		...
		.replace(/(G|K|L|Y)A/g, "$1Ä")
		.replace(/(G|K|L|Y)I/g, "$1İ")
		.replace(/(G|K|L|Y)O/g, "$1Ö")
		.replace(/(G|K|L|Y)U/g, "$1Ü")
		.replace(/(G|K|L|Y|g|k|l|y)a/g, "$1ä")
		.replace(/(G|K|L|Y|g|k)ı/g, "$1i")
		.replace(/(G|K|L|Y|g|k|l|y)o/g, "$1ö")
		.replace(/(G|K|L|Y|g|k|l|y)u/g, "$1ü")
