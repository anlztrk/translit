function cyrlat() {
	...
	document.transcription.text2.value = document.transcription.text1.value
		...
		.replace(/(G|H|K|Y)A/g, "$1Ä")
		.replace(/(G|H|K|Y)I/g, "$1İ")
		.replace(/(G|H|K|Y)O/g, "$1Ö")
		.replace(/(G|H|K|Y)U/g, "$1Ü")
		.replace(/(G|H|K|Y|g|h|k|y)a/g, "$1ä")
		.replace(/(G|H|K|Y|g|h|k|y)ı/g, "$1i")
		.replace(/(G|H|K|Y|g|h|k|y)o/g, "$1ö")
		.replace(/(G|H|K|Y|g|h|k|y)u/g, "$1ü")
