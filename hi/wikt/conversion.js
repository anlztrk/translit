...
car = car.replace(/\u200c्/g, "");
car = car.replace(/\u200c(क़|ख़|ग़|ज़|झ़|फ़|ड़|ढ़|क|ख|ग|घ|ङ|ह|च|छ|ज|झ|ञ|य|श|ट|ठ|ड|ढ|ण|र|ष|त|थ|द|ध|न|ल|स|प|फ|ब|भ|म|व|ळ|व़|इ|उ|ऋ|ए|ओ|आ|ई|ऊ|ऐ|औ|ः|ि|ु|ृ|े|ो|ा|ी|ू|ै|ौ)/g, "a$1");
car = car.replace(/\u200c/g, "");
