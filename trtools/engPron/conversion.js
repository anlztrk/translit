function cyrlat() {
	document.transcription.text2.value = document.transcription.text1.value
		...
		.replace(/\.([bʤʧdfɡhɟʒlɫmnŋɲpɾsʃtvβjz])ɑ([flɫmnstz])/g, '.$1U$2$2')
		.replace(/\.[kc]ɑ([flɫmnstz])/g, '.CU$1$1')
		...
		.replace(/ɑ[kc]/g, 'AHK')
		.replace(/([ʤʧlɫmvβjz])ɑn/g, '$1UNN')
		.replace(/[kc]ɑn/g, 'CUNN')
		.replace(/tɑn/g, 'TAHN')
		.replace(/([ʤdflɫnpʃtvβz])ɑm/g, '$1UMM')
		.replace(/[kc]ɑm/g, 'CUM')
