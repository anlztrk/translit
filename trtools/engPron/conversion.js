function cyrlat() {
	document.transcription.text2.value = document.transcription.text1.value
		...
		.replace(/(?<=[bʤʧdfɡhɟʒkclɫmnŋɲpɾsʃtvβjz])ɑ([fnts])(?![bʤʧdfɡɟʒkclɫmnŋɲpɾstʃvβz])/g, 'U$1$1')
		.replace(/(?<=[bʤʧdfɡhɟʒkclɫmnŋɲpɾsʃtvβjz])ɑ(?=[bʤdfɡɟʒmnŋɲpstvβz])/g, 'U')
		.replace(/(?<=[bʤʧdfɡhɟʒkclɫmnŋɲpɾsʃtvβjz])ɑ[ck]/g, 'UCK')
		.replace(/(?<=[bʤʧdfɡhɟʒkclɫmnŋɲpɾsʃtvβjz])ɑʤ/g, 'UDGE')
		.replace(/(?<=[bʤʧdfɡhɟʒkclɫmnŋɲpɾsʃtvβjz])ɑ(?=[bʤʧdfɡɟʒkclɫmnŋɲpɾstʃvβz])/g, 'AH')
