...
car = document.transcription.text1.value;  
  ...
  car = car.replace(/ʊɹ(b|dʒ|tʃ|d|f|ɡ|h|ʒ|k|l|m|n|ŋ|p|ɹ|s|ʃ|t|v|w|z)/g, "OOR$1");
  ...
  car = car.replace(/ʊɹ/g, "OORR");
  car = car.replace(/əɹ/g, "ƏR");
  car = car.replace(/æ/g, "A");  
  car = car.replace(/ɒ/g, "O");  
  car = car.replace(/ʊ/g, "OO");
  car = car.replace(/ə/g, "Ə");
  
  car = car.replace(/(A|AH|AIR|AR|ARR|AW|AY|E|EH|EE|EW|EWR|EYE|I|IH|IRE|IRR|O|OH|OIR|OO|OOR|OR|ORR|OW|OWR|OU|U|UH|UR|URR|Y|Ə|ƏR|m|n|ŋ|b|d|dʒ|ɡ|v|ð|z|ʒ)s/g, "$1SS");
  car = car.replace(/ɡ(E|I)/g, "GH$1");
  car = car.replace(/(A|AH|AIR|AR|ARR|AW|AY|E|EH|EE|EW|EWR|EYE|I|IH|IRE|IRR|O|OH|OIR|OO|OOR|OR|ORR|OW|OWR|OU|U|UH|UR|URR|Y|Ə|ƏR)tʃ/g, "$1TCH");
