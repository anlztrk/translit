function cyrlat() {
	document.transcription.text2.value = document.transcription.text1.value
		...
		.replace(/(^|\.|\s)([bʤʧdfɡhʒkɫmnpɾsʃtvjz])([bʤʧdfɡhʒkɫmnpɾsʃtvjz])([aâoûuɯeêiîyœ])/g, "$1$2ɯ.$3$4")
		...
		.replace(/([ɑeiu])\.([bʤʧdfɡɟʒkclɫmnŋɲpɾsʃtvβjz])/g, '$1$2\.')
		...
		.replace(/([bʤʧfɡɟhʒkclɫmnŋɲpɾʃvβ])(y|yː)([bʤʧdfɡɟʒkclɫmnŋɲpɾsʃtvβz])/g, '$1U$3E')
		...
		.replace(/ɑ[kc]/g, 'AHK')
		.replace(/([bʤʧdfɡhɟʒkclɫmnŋɲpɾsʃtvβjz])ɑ([bdfɡɟmnpɾstz])/g, '$1U$2$2')
		.replace(/ɑ([bdfɡɟmnpɾstz])/g, 'AH$1')
		.replace(/([bʤʧdfɡhɟʒkclɫmnŋɲpɾsʃtvβjz])ɑ([ʤʧʒkclɫŋɲʃvβ])/g, '$1U$2')
