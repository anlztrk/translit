function cyrlat() {
	document.transcription.text2.value = document.transcription.text1.value
		...
		.replace(/œɾ/g, 'UR')
		.replace(/oːɾ|oɾ/g, 'OR')
		.replace(/([bʤʧdfɡɟʒkclɫmnŋɲpɾsʃtvβz])(oː|o|œː|œ)([bʤʧdfɡɟʒkclɫmnpɾsʃtvβz])(?![bʤʧdfɡɟʒkclɫmnŋɲpɾsʃtvβz])/g, '$1O$3E')
		.replace(/(oː|o|œː|œ)([bʤʧdfɡɟʒkclɫmpɾsʃtvβz])(?![bʤʧdfɡɟʒkclɫmnŋɲpɾsʃtvβz])/g, 'O$2E')
