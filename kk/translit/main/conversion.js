...
car = document.transcription.text1.value;
  ...
  car = car.replace(/(Б|В|Г|Ғ|Д|Ж|З|Й|К|Қ|Л|М|Н|Ң|П|Р|С|Т|Ф|Х|Ш|Ь|Ъ)У(Ә|Е|И|Ө|Ү|І)/g, "$1ҮЎ$2");
  ...
  car = car.replace(/(Б|В|Г|Ғ|Д|Ж|З|Й|К|Қ|Л|М|Н|Ң|П|Р|С|Т|Ф|Х|Ш|Ь|Ъ|б|в|г|ғ|д|ж|з|й|к|қ|л|м|н|ң|п|р|с|т|ф|х|ш|ь|ъ)у(ә|е|и|ө|ү|і)/g, "$1үў$2");
  ...
  car = car.replace(/И(а|о|ұ|ы)/g, "Ый$2");
  car = car.replace(/и(а|о|ұ|ы)/g, "ый$2");
  car = car.replace(/И(Ә|Е|И|Ө|Ү|І|Э)/g, "ІЙ$1");
  car = car.replace(/И(ә|е|и|ө|ү|і|э)/g, "Ій$1");
  car = car.replace(/и(ә|е|и|ө|ү|і|э)/g, "ій$1");
