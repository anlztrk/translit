...
car = document.transcription.text1.value;
  ...
  //У
  car = car.replace(/(Б|В|Г|Ғ|Д|Ж|З|Й|К|Қ|Л|М|Н|Ң|П|Р|С|Т|Ф|Х|Ш|Ь|Ъ)У(А|О|У|Ұ|Ы|Ә|Е|И|Ө|У|Ү|І)/g, "$1Ұ\u0302Ў$2");
  car = car.replace(/(Б|В|Г|Ғ|Д|Ж|З|Й|К|Қ|Л|М|Н|Ң|П|Р|С|Т|Ф|Х|Ш|Ь|Ъ|б|в|г|ғ|д|ж|з|й|к|қ|л|м|н|ң|п|р|с|т|ф|х|ш|ь|ъ)у(а|о|у|ұ|ы|ә|е|и|ө|у|ү|і)/g, "$1ұ\u0302ў$2");
