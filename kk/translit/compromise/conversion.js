function cyrlat() {
	...
	document.transcription.text2.value = document.transcription.text1.value
		...
		.replace(/Ӯ(А|Ә|Е|И|О|Ө|Ӯ|Ұ|Ү|Ы|І|Э)/g, "ӮУ$1")
		.replace(/(Ӯ|ӯ)(а|ә|е|и|о|ө|ӯ|ұ|ү|ы|і|э)/g, "$1у$2")

		.replace(/И(А|Ә|Е|И|О|Ө|Ӯ|Ұ|Ү|Ы|І|Э)/g, "ИЙ$1")
		.replace(/(И|и)(а|ә|е|и|о|ө|ӯ|ұ|ү|ы|і|э)/g, "$1й$2")
