...
car = document.transcription.text1.value;
  ...
  car = car.replace(/(У|Ӯ|у|ӯ)(б|в|г|ғ|д|ж|з|й|к|қ|л|м|н|ң|п|р|с|т|ў|ф|х|һ|ц|ч|ш)/g, "ыў$2");
  car = car.replace(/(У|Ӯ)(Б|В|Г|Ғ|Д|Ж|З|Й|К|Қ|Л|М|Н|Ң|П|Р|С|Т|Ў|Ф|Х|Һ|Ц|Ч|Ш)/g, "ЫЎ$2");
  car = car.replace(/(Ӱ|ӱ)(б|в|г|ғ|д|ж|з|й|к|қ|л|м|н|ң|п|р|с|т|ў|ф|х|һ|ц|ч|ш)/g, "ыў$2");
  car = car.replace(/Ӱ(Б|В|Г|Ғ|Д|Ж|З|Й|К|Қ|Л|М|Н|Ң|П|Р|С|Т|Ў|Ф|Х|Һ|Ц|Ч|Ш)/g, "ЫЎ$1");
