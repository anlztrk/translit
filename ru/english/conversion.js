...
car = car.replace(/ю/g, "ьу");
car = car.replace(/(\p{Uppercase})(\p{Uppercase}) Щ/ug, "$1$2 Ш\u0048");
car = car.replace(/Щ (\p{Uppercase})(\p{Uppercase})/ug, "Ш\u0048 $1$2");
car = car.replace(/Щ(\p{Uppercase})/ug, "Ш\u0048$1");
car = car.replace(/Щ/g, "Ш\u0068");
car = car.replace(/щ/g, "ш\u0068");
car = car.replace(/(\p{Uppercase})(\p{Uppercase}) Ш/ug, "$1$2 С\u0048");
car = car.replace(/Ш (\p{Uppercase})(\p{Uppercase})/ug, "С\u0048 $1$2");
car = car.replace(/Ш(\p{Uppercase})/ug, "С\u0048$1");
car = car.replace(/Ш/g, "С\u0068");
car = car.replace(/ш/g, "с\u0068");
car = car.replace(/(\p{Uppercase})(\p{Uppercase}) Ж/ug, "$1$2 З\u0048");
car = car.replace(/Ж (\p{Uppercase})(\p{Uppercase})/ug, "З\u0048 $1$2");
car = car.replace(/Ж(\p{Uppercase})/ug, "З\u0048$1");
car = car.replace(/Ж/g, "З\u0068");
car = car.replace(/ж/g, "з\u0068");
...
car = car.replace(/ч/g, "\u0063\u0068");
car = car.replace(/(\p{Uppercase})(\p{Uppercase}) Х/ug, "$1$2 К\u0048");
car = car.replace(/Х (\p{Uppercase})(\p{Uppercase})/ug, "К\u0048 $1$2");
car = car.replace(/Х(\p{Uppercase})/ug, "К\u0048$1");
car = car.replace(/Х/g, "К\u0068");
car = car.replace(/х/g, "к\u0068");
...
car = car.replace(/(Б|В|Г|Д|Џ|З|К|Л|М|Н|П|Р|С|Т|Ф|\u0048)Ь(А|И|Ы|О|У)/g, "$1И$2");
car = car.replace(/(Б|В|Г|Д|Џ|З|К|Л|М|Н|П|Р|С|Т|Ф|\u0048|б|в|г|д|џ|з|к|л|м|н|п|р|с|т|ф|\u0068)ь(а|и|ы|о|у)/g, "$1и$2");
car = car.replace(/(Б|В|Г|Д|Џ|З|К|Л|М|Н|П|Р|С|Т|Ф|\u0048)ЬЭ/g, "$1Э");
car = car.replace(/(Б|В|Г|Д|Џ|З|К|Л|М|Н|П|Р|С|Т|Ф|\u0048|б|в|г|д|џ|з|к|л|м|н|п|р|с|т|ф|\u0068)ьэ/g, "$1э");
