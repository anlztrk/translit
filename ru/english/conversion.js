...
car = car.replace(/(С|З)Х/g, "$1\u2019Х");
car = car.replace(/(С|З|с|з)х/g, "$1\u2019х");
/*car = car.replace(/Ш(Х|х)/g, "Ш\u2019$1");
car = car.replace(/шх/g, "ш\u2019х");
...
car = car.replace(/(Б|В|Г|Д|Џ|З|К|Л|М|Н|П|Р|С|Т|Ф|Х)Ь(А|И|Ы|О|У)/g, "$1І$2");
car = car.replace(/(Б|В|Г|Д|Џ|З|К|Л|М|Н|П|Р|С|Т|Ф|Х|б|в|г|д|џ|з|к|л|м|н|п|р|с|т|ф|х)ь(а|и|ы|о|у)/g, "$1і$2");
...
car = car.replace(/I(Ẏ|ẏ)/g, "I");
car = car.replace(/iẏ/g, "i");
...
car = car.replace(/(A|E|I|O|U|Y|Ẏ)Ẏ((?!A|E|I|O|U|Y|Ẏ))/g, "$1I$2");
car = car.replace(/(A|E|I|O|U|Y|Ẏ|a|e|i|o|u|y|ẏ)ẏ((?!a|e|i|o|u|y|ẏ))/g, "$1i$2");
