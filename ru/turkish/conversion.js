...
translit = translit.replace(/(А|Э|Ы|И|О|У|Я|Е|Ё|Ю|а|э|ы|и|о|у|я|е|ё|ю)щ(А|Э|Ы|И|О|У|Я|Е|Ё|Ю|а|э|ы|и|о|у|я|е|ё|ю)/g, "$1шш$2");
translit = translit.replace(/(А|Э|Ы|И|О|У|Я|Е|Ё|Ю)Щ(А|Э|Ы|И|О|У|Я|Е|Ё|Ю)/g, "$1ШШ$2");
translit = translit.replace(/(А|Э|Ы|И|О|У|Я|Е|Ё|Ю)Щ(а|э|ы|и|о|у|я|е|ё|ю)/g, "$1Шш$2");
translit = translit.replace(/(а|э|ы|и|о|у|я|е|ё|ю)Щ(А|Э|Ы|И|О|У|Я|Е|Ё|Ю)/g, "$1ШШ$2");
