...
car = car.replace(/(Б|В|Г|Ґ|Д|Џ|З|К|Л|М|Н|П|Р|С|Т|Ф)Ь(А|Е|І|И|О|У)/g, "$1І");
car = car.replace(/(Б|В|Г|Ґ|Д|Џ|З|К|Л|М|Н|П|Р|С|Т|Ф|б|в|г|ґ|д|џ|з|к|л|м|н|п|р|с|т|ф)ь(а|е|і|и|о|у)/g, "$1і");
