...
car = document.transcription.text1.value;
  ...
  car = car.replace(/ЯЕ/g, "Y\u005BÄYЭ\u007CAYЫ\u005D");
  car = car.replace(/ОЕ/g, "OYЫ");
  car = car.replace(/УЕ/g, "UYЫ");
  car = car.replace(/ЮЕ/g, "Y\u005BÜWЭ\u007CUYЫ\u005D");
  car = car.replace(/ЕЕ/g, "Y\u005BEYЭ\u007CIYЫ\u005D");
  car = car.replace(/ӘЕ/g, "ÄYЭ");
  car = car.replace(/ЭЕ/g, "EYЭ");
  car = car.replace(/ИЕ/g, "İYЭ");
  car = car.replace(/ӨЕ/g, "ÖYЭ");
  car = car.replace(/ҮЕ/g, "ÜWЭ");
  ...
  car = car.replace(/Уе/g, "Uyы");
  car = car.replace(/Юе/g, "Y\u005Büwэ\u007Cuyы\u005D");
  car = car.replace(/Ее/g, "Y\u005Beyэ\u007Cıyы\u005D");
  car = car.replace(/Әе/g, "Äyэ");
  car = car.replace(/Эе/g, "Eyэ");
  car = car.replace(/Ие/g, "İyэ");
  car = car.replace(/Өе/g, "Öyэ");
