...
car = document.transcription.text1.value;
 ...
 // Handle Щ: Replace it with ЧЧ or Ч depending on context
  ...
  car = car.replace(/Ү(Б|В|Г|Д|Ж|Җ|З|К|Л|М|Н|Ң|П|Р|С|Т|Ф|Х|Һ|Ц|Ч|Ш|Щ){0,2}ЙЫ/g, "Ү$1Э");
  car = car.replace(/(Ү|ү)(б|в|г|д|ж|җ|з|к|л|м|н|ң|п|р|с|т|ф|х|һ|ц|ч|ш|щ){0,2}йы/g, "$1$2э");
