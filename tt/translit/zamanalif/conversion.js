...
car = document.transcription.text1.value;
  ...
  car = car.replace(/(\p{Uppercase})Е/ug, "$1ЙЫ");
  ...
  car = car.replace(/([ИЭӘӨҮ])([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,2})ЙА/g, "$1$2ЙӘ");
  car = car.replace(/([ИЭӘӨҮиэәөү])([бвгджҗзклмнңпрстфхһцчшщ]{0,2})йа/g, "$1$2йә");
  car = car.replace(/([ИЭӘӨҮ])([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,2})ЙЫ/g, "$1$2Э");
  car = car.replace(/([ИЭӘӨҮиэәөү])([бвгджҗзклмнңпрстфхһцчшщ]{0,2})йы/g, "$1$2э");
  car = car.replace(/([ИЭӘӨҮ])([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,2})ЙО/g, "$1$2ЙӨ");
  car = car.replace(/([ИЭӘӨҮиэәөү])([бвгджҗзклмнңпрстфхһцчшщ]{0,2})йо/g, "$1$2йө");
  car = car.replace(/([ИЭӘӨҮ])([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,2})ЙУ/g, "$1$2ЙҮ");
  car = car.replace(/([ИЭӘӨҮиэәөү])([бвгджҗзклмнңпрстфхһцчшщ]{0,2})йу/g, "$1$2йү");
  
  car = car.replace(/ЙА([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙӘ$1$2");
  car = car.replace(/(Й|й)а([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1ә$2$3");
  car = car.replace(/ЙО([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙӨ$1$2");
  car = car.replace(/(Й|й)о([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1ө$2$3");
  car = car.replace(/ЙУ([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙҮ$1$2");
  car = car.replace(/(Й|й)у([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1ү$2$3");
  car = car.replace(/ЙЫЙ([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙИ$1$2");
  car = car.replace(/(Й|й)ый([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1и$2$3");
  car = car.replace(/ЙЫ([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙЭ$1$2");
  car = car.replace(/(Й|й)ы([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1э$2$3");
