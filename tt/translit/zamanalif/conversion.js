...
car = document.transcription.text1.value;
  ...
  car = car.replace(/([ИЭӘӨҮ])([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,2})ЙА/g, "$1$2$3ЙӘ");
  car = car.replace(/([ИЭӘӨҮиэәөү])([бвгджҗзклмнңпрстфхһцчшщ]{0,2})йа/g, "$1$2$3йә");
  car = car.replace(/([ИЭӘӨ])([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,2})ЙЫ/g, "$1$2$3ЙЭ");
  car = car.replace(/([ИЭӘӨиэәө])([бвгджҗзклмнңпрстфхһцчшщ]{0,2})йы/g, "$1$2$3йэ");
  car = car.replace(/([ИЭӘӨҮ])([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,2})ЙО/g, "$1$2$3ЙӨ");
  car = car.replace(/([ИЭӘӨҮиэәөү])([бвгджҗзклмнңпрстфхһцчшщ]{0,2})йо/g, "$1$2$3йө");
  car = car.replace(/([ИЭӘӨҮ])([БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,2})ЙУ/g, "$1$2$3ЙҮ");
  car = car.replace(/([ИЭӘӨҮиэәөү])([бвгджҗзклмнңпрстфхһцчшщ]{0,2})йу/g, "$1$2$3йү");
  car = car.replace(/ҮЙЫ/g, "ҮЭ");
  car = car.replace(/Үйы/g, "Үэ");
  car = car.replace(/үйы/g, "үэ");
  
  car = car.replace(/ЙА[БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙӘ$1$2$3$4");
  car = car.replace(/(Й|й)а([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1ә$2$3$4$5");
  car = car.replace(/ЙО[БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙӨ$1$2$3$4");
  car = car.replace(/(Й|й)о([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1ө$2$3$4$5");
  car = car.replace(/ЙУ[БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙҮ$1$2$3$4");
  car = car.replace(/(Й|й)у([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1ү$2$3$4$5");
  car = car.replace(/ЙЫЙ[БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙИ$1$2$3$4");
  car = car.replace(/(Й|й)ый([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1и$2$3$4$5");
  car = car.replace(/ЙЫ[БВГДЖҖЗКЛМНҢПРСТФХҺЦЧШЩ]{0,3})(И|Э|Ә|Ө|Ү|Ь)/g, "ЙЭ$1$2$3$4");
  car = car.replace(/(Й|й)ы([бвгджҗзклмнңпрстфхһцчшщ]{0,3})(и|э|ә|ө|ү|ь)/g, "$1э$2$3$4$5");
  ...
  car = car.replace(/([ҒҚ])А([БВГҒДЖҖЗКҚЛМНҢПРСТФХҺЦЧШЩ]{0,3})([ИЭӘӨҮЬ])/g, "$1Ә$2$3");
  car = car.replace(/([ҒҚғқ])а([бвгғджҗзкқлмнңпрстфхһцчшщ]{0,3})([иэәөүь])/g, "$1ә$2$3");  
  car = car.replace(/([ҒҚ])ЫЙ([БВГҒДЖҖЗКҚЛМНҢПРСТФХҺЦЧШЩ]{0,3})([ИЭӘӨҮЬ])/g, "$1И$2$3");
  car = car.replace(/([ҒҚғқ])ый([бвгғджҗзкқлмнңпрстфхһцчшщ]{0,3})([иэәөүь])/g, "$1и$2$3");  
  car = car.replace(/([ҒҚ])Ы([БВГҒДЖҖЗКҚЛМНҢПРСТФХҺЦЧШЩ]{0,3})([ИЭӘӨҮЬ])/g, "$1Э$2$3");
  car = car.replace(/([ҒҚғқ])ы([бвгғджҗзкқлмнңпрстфхһцчшщ]{0,3})([иэәөүь])/g, "$1э$2$3");
  car = car.replace(/([ҒҚ])О([БВГҒДЖҖЗКҚЛМНҢПРСТФХҺЦЧШЩ]{0,3})([ИЭӘӨҮЬ])/g, "$1Ө$2$3");
  car = car.replace(/([ҒҚғқ])о([бвгғджҗзкқлмнңпрстфхһцчшщ]{0,3})([иэәөүь])/g, "$1ө$2$3"); 
  car = car.replace(/([ҒҚ])У([БВГҒДЖҖЗКҚЛМНҢПРСТФХҺЦЧШЩ]{0,3})([ИЭӘӨҮЬ])/g, "$1Ү$2$3");
  car = car.replace(/([ҒҚғқ])у([бвгғджҗзкқлмнңпрстфхһцчшщ]{0,3})([иэәөүь])/g, "$1ү$2$3");
