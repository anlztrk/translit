...
car = car.replace(/ЪЕ/g, "ЪYE");
  ...
  car = car.replace(/ак/g, "ақ");
  car = car.replace(/як/g, "яқ");
  car = car.replace(/ык/g, "ық");
  car = car.replace(/ок/g, "оқ");
  car = car.replace(/ёк/g, "ёқ");
  car = car.replace(/ук/g, "уқ");
  car = car.replace(/юк/g, "юқ");
  car = car.replace(/ка/g, "қа");
  car = car.replace(/кы/g, "қы");
  car = car.replace(/ко/g, "қо");
  car = car.replace(/ку/g, "қу");
  car = car.replace(/қе/g, "ке");
  car = car.replace(/қи/g, "ки");
  car = car.replace(/қө/g, "кө");
  car = car.replace(/қү/g, "кү");
  ...
  car = car.replace(/ҒҮ/g, "ГҮ");
  car = car.replace(/АК/g, "АҚ");
  car = car.replace(/ЯК/g, "ЙАҚ");
  car = car.replace(/ЫК/g, "ЫҚ");
  car = car.replace(/ОК/g, "ОҚ");
  car = car.replace(/ЁК/g, "ЙОҚ");
  car = car.replace(/УК/g, "УҚ");
  car = car.replace(/ЮК/g, "ЙУҚ");
  car = car.replace(/КА/g, "ҚА");
  car = car.replace(/КЫ/g, "ҚЫ");
  car = car.replace(/КО/g, "ҚО");
  car = car.replace(/КУ/g, "ҚУ");
