...
function cyrlat() {
	...
	car = car.replace(/(?<!(Б|В|Г|Д|Ж|З|К|Л|М|Н|П|Р|С|Т|Ф|Х|Ц|Ч|Ш|Щ|Ь|Ъ))Ь(А|Э|Ы|И|О|Ө|У|Ү|а|э|ы|и|о|ө|у|ү)/g, "$1Й$2");
	car = car.replace(/(?<!(Б|В|Г|Д|Ж|З|К|Л|М|Н|П|Р|С|Т|Ф|Х|Ц|Ч|Ш|Щ|Ь|Ъ|б|в|г|д|ж|з|к|л|м|н|п|р|с|т|ф|х|ц|ч|ш|щ|ь|ъ))ь(а|э|ы|и|о|ө|у|ү)/g, "$1й$2");
