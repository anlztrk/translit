...
car = car.replace(/(А|И|О|Ө|У|Ү|Э|а|и|о|ө|у|ү|э)(И|и)/g, "$1\u02bc$2");
car = car.replace(/(И|и)(А|И|О|Ө|У|Ү|Э|а|и|о|ө|у|ү|э)/g, "$1\u02bc$2");

car = car.replace(/(А|И|О|Ө|У|Ү|Ы|Э|а|и|о|ө|у|ү|ы|э)й(А|И|О|Ө|У|Ү|Ы|Э|а|и|о|ө|у|ү|ы|э)/g, "$1ӣ$2");
car = car.replace(/(А|И|О|Ө|У|Ү|Ы|Э|а|и|о|ө|у|ү|ы|э)Й(А|И|О|Ө|У|Ү|Ы|Э|а|и|о|ө|у|ү|ы|э)/g, "$1Ӣ$2");
car = car.replace(/(А|Б|В|Г|Д|Ж|З|И|Й|К|Л|М|Н|О|Ө|П|Р|С|Т|У|Ү|Ф|Х|Ц|Ч|Ш|Щ|Ъ|Ь|Э|а|б|в|г|д|ж|з|и|й|к|л|м|н|о|ө|п|р|с|т|у|ү|ф|х|ц|ч|ш|щ|ъ|ь|э)й/g, "$1и");
car = car.replace(/(А|Б|В|Г|Д|Ж|З|И|Й|К|Л|М|Н|О|Ө|П|Р|С|Т|У|Ү|Ф|Х|Ц|Ч|Ш|Щ|Ъ|Ь|Э|а|б|в|г|д|ж|з|и|й|к|л|м|н|о|ө|п|р|с|т|у|ү|ф|х|ц|ч|ш|щ|ъ|ь|э)Й/g, "$1И");
