...
function cyrlat() {
	...
	car = car.replace(/Ь(А|Э|Ы|И|О|Ө|У|Ү|а|э|ы|и|о|ө|у|ү)/g, "Й$1");
	car = car.replace(/ь(а|э|ы|и|о|ө|у|ү)/g, "й$1");

	car = car.replace(/(А|Э|Ы|И|О|Ө|У|Ү)Й/g, "$1И");
	car = car.replace(/(А|Э|Ы|И|О|Ө|У|Ү|а|э|ы|и|о|ө|у|ү)й/g, "$1и");
