...
car = document.transcription.text1.value;
  ...
  car = car.replace(/é/g, "эа\u032f");
  car = car.replace(/Є/g, "эа\u032f");
  ...
  car = car.replace(/н/g, "ȵ");
  car = car.replace(/ш/g, "ɕ");
  car = car.replace(/щ/g, "t͡ɕ");
  car = car.replace(/ж/g, "ʑ");
  car = car.replace(/ч/g, "d͡ʑ");
  car = car.replace(/с/g, "s");
  car = car.replace(/і/g, "ɪː");
  car = car.replace(/б/g, "b");
  car = car.replace(/ф/g, "f");
  car = car.replace(/в/g, "v");
  car = car.replace(/т/g, "t͡θ");
  car = car.replace(/л/g, "ȴ");
  car = car.replace(/э/g, "ɛ");
  car = car.replace(/ю/g, "ʊː");
  car = car.replace(/ц/g, "t͡s");
  car = car.replace(/ѕ/g, "d͡z");
