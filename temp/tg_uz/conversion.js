...
car = car.replace(/И(Й|й)/g, "И$1\u0300");
car = car.replace(/ий/g, "и$1\u0300");
...
car = car.replace(/ю/g, "йу");
car = car.replace(/(\p{Uppercase})(\p{Uppercase}) Ӣ/ug, "$1$2 ИЙ");
car = car.replace(/Ӣ (\p{Uppercase})(\p{Uppercase})/ug, "ИЙ $1$2");
car = car.replace(/Ӣ(\p{Uppercase})/ug, "ИЙ$1");
car = car.replace(/Ӣ/g, "Ий");
car = car.replace(/ӣ/g, "ий");
...
car = car.replace(/(B|J|Ç|D|F|G|H|Ž|K|L|M|N|P|Q|R|S|Š|T|V|Y|X|Ǧ|Y|Z)Е/g, "$1ЙЕ");
car = car.replace(/(B|J|Ç|D|F|G|H|Ž|K|L|M|N|P|Q|R|S|Š|T|V|Y|X|Ǧ|Y|Z|b|c|ç|d|f|g|h|ž|k|l|m|n|p|q|r|s|š|t|v|y|x|ǧ|y|z)е/g, "$1йе");
car = car.replace(/(B|J|Ç|D|F|G|H|Ž|K|L|M|N|P|Q|R|S|Š|T|V|Y|X|Ǧ|Y|Z)E/g, "$1Е");
