...
//getting the Latin letters out of the way
  ...
  translit = translit.replace(/ㅢ/g, "ĩ");

  translit = translit.replace(/c\u0323h/g, "ḉ");
  ...
  translit = translit.replace(/ḳ/g, "ḱ");
  translit = translit.replace(/ṭ/g, "t\u0301");
  translit = translit.replace(/ṣ/g, "ś");
  translit = translit.replace(/ṗ/g, "ṕ");
  translit = translit.replace(/j/g, "c");
  translit = translit.replace(/w/g, "v");
  translit = translit.replace(/ũ/g, "ı");
  translit = translit.replace(/õ/g, "ꜵ");
  translit = translit.replace(/è/g, "e");
  translit = translit.replace(/(a|e|ı|i|o|ꜵ|u)(a|e|i|ı|ĩ|o|ꜵ|u)/g, "$1ğ$2");
  translit = translit.replace(/ĩ/g, "ıy");
  translit = translit.replace(/ğ-(a|e|ı|i|o|ꜵ|u)/g, "ğ$1");
