...
car = document.transcription.text1.value;
  ...
  car = car.replace(/Ւ( |)(ա|բ|ջ|չ|դ|ե|է|ֆ|գ|հ|ը|ի|ժ|ք|լ|մ|ն|ո|փ|կ|ռ|ս|շ|թ|օ|վ|խ|յ|զ)/g, 'ւ$1$2');
  car = car.replace(/(ա|բ|ջ|չ|դ|ե|է|ֆ|գ|հ|ը|ի|ժ|ք|լ|մ|ն|ո|փ|կ|ռ|ս|շ|թ|օ|վ|խ|յ|զ)( |)(Ո|Օ)Ւ/g, '$1$2$3ւ');
