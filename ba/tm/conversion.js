...
car = car.replace(/ е/g, " ýi");
car = car.replace(/\nе/g, "\nýi");
car = car.replace(/\rе/g, "\rýi");
car = car.replace(/^е/g, "ýi");

car = car.replace(/ае/g, "аýi");
car = car.replace(/әе/g, "eýi");
car = car.replace(/ие/g, "иýi");
car = car.replace(/ые/g, "ыýi");
car = car.replace(/ее/g, "еýi");
car = car.replace(/эе/g, "эýi");
car = car.replace(/уе/g, "уýi");
car = car.replace(/ое/g, "оýi");
car = car.replace(/өе/g, "өýi");
car = car.replace(/ёе/g, "ёýi");
car = car.replace(/үе/g, "үýi");
car = car.replace(/йе/g, "йýi");
car = car.replace(/юе/g, "юýi");
car = car.replace(/яе/g, "яýi");
