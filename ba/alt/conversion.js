...
car = car.replace(/АЕ/g, "АYİ");
car = car.replace(/ӘЕ/g, "EYİ");
car = car.replace(/ИЕ/g, "ИYİ");
car = car.replace(/ЫЕ/g, "ЫYİ");
car = car.replace(/ЕЕ/g, "ЕYİ");
car = car.replace(/ЭЕ/g, "ЭYİ");
car = car.replace(/УЕ/g, "УYİ");
car = car.replace(/ОЕ/g, "ОYİ");
car = car.replace(/ӨЕ/g, "ӨYİ");
car = car.replace(/ЁЕ/g, "ЁYİ");
car = car.replace(/ҮЕ/g, "ҮYİ");
car = car.replace(/ЙЕ/g, "ЙYİ");
car = car.replace(/ЮЕ/g, "ЮYİ");
car = car.replace(/ЯЕ/g, "ЯYİ");
